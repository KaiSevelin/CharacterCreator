...
export function registerChargenSettings() {
    game.settings.register(CHARGEN_MODULE_ID, SETTING_KEYS.storyEnabled, {
        name: "Story Threads Enabled",
        hint: "Enable the parallel story-thread system during character generation.",
        scope: "world",
        config: true,
        type: Boolean,
        default: true
...
export function getChargenSettings() {
    return {
        storyEnabled: Boolean(getChargenSetting(SETTING_KEYS.storyEnabled)),
